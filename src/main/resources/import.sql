...
insert into tb_restaurante (nome, taxa_frete, cozinha_id) value ('Thai Gourmet', 0, 2);
insert into tb_restaurante (nome, taxa_frete, cozinha_id) value ('Thai Delivery', 9.50, 2);
insert into tb_restaurante (nome, taxa_frete, cozinha_id) value ('Tuk Tuk Comida Indiana', 15, 1);
